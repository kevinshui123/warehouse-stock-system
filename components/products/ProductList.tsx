...
const ProductList = React.memo(() => {
  ...
  const columns = useMemo(
    () =>
      createProductColumns(t, detailBase, {
        forSupplier: isSupplierProductsPage,
      }),
    [t, detailBase, isSupplierProductsPage],
  );
      ...
      <div className="pb-6 flex flex-col items-start text-left">
        <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 dark:text-white pb-2">
          {isSupplierProductsPage
            ...
            : t("products.inventorySectionTitle")}
        </h2>
        <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400">
          {isSupplierProductsPage
            ? t("products.myProductsDescription")
              ...
              return (
                <>
                  <StatisticsCard
                    ...
                    description={t("supplier_portal.productsCatalog")}
                    icon={Package}
                    variant="rose"
                    badges={[
                      {
            ...
            <>
              <StatisticsCard
                ...
                badges={[
                  ...
                  {
                    label: t("admin.analytics.stockLow"),
                    value: dashboard.productStatusBreakdown?.stockLow ?? 0,
                  },
                  {
                    label: t("admin.analytics.stockOut"),
              ...
              <StatisticsCard
                ...
                badges={[
                  {
                    label: t("insights.ordersRevenueOverTime"),
                  ...
                  {
                    label: t("insights.invoicesLabel"),
