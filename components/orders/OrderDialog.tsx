      ...
      >
        <DialogHeader>
          <DialogTitle className="text-[22px] text-white">
            {editingOrder
              ? `${t("orders.updateOrder")} ${editingOrder.orderNumber}`
              : t("orders.createOrder")}
          </DialogTitle>
          <DialogDescription className="text-white/70">
            {editingOrder
              ? t("orders.updateOrderDescription")
            ...
            <form onSubmit={editFormMethods.handleSubmit(handleUpdateOrder)}>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="sm:col-span-2">
                  <FormField
                    ...
                    placeholder={t("orders.enterOrderNotes")}
                    labelClassName="text-white/80"
                    inputClassName="border-violet-400/30 dark:border-white/20 bg-white/10 dark:bg-white/5 backdrop-blur-sm text-white placeholder:text-white/40 focus-visible:border-violet-400 focus-visible:ring-violet-500/50 shadow-[0_10px_30px_rgba(139,92,246,0.15)]"
                  />
                </div>
              ...
              <DialogFooter className="mt-9 mb-4 flex flex-col sm:flex-row items-center gap-4">
                ...
                <Button
                  ...
                  disabled={isUpdating}
                >
                  {isUpdating ? t("common.loading") : t("orders.updateOrder")}
                </Button>
              </DialogFooter>
            </form>
          </FormProvider>
          ...
          <FormProvider {...createFormMethods}>
            ...
            >
              <div className="space-y-6">
                        ...
                        {selectedProduct && (
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div className="text-sm text-white/70">
                              {t("orders.subtotal")}: ${itemSubtotal.toFixed(2)} (
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <FormField
                      ...
                      label={t("orders.streetAddress")}
                      placeholder={t("orders.enterStreetAddress")}
                      labelClassName="text-white/80"
                      inputClassName="border-violet-400/30 dark:border-white/20 bg-white/10 dark:bg-white/5 backdrop-blur-sm text-white placeholder:text-white/40 focus-visible:border-violet-400 focus-visible:ring-violet-500/50 shadow-[0_10px_30px_rgba(139,92,246,0.15)]"
                    />
                    <FormField
                    ...
                    <FormField
                      ...
                      label={t("orders.stateProvince")}
                      placeholder={t("orders.enterState")}
                      labelClassName="text-white/80"
                      inputClassName="border-violet-400/30 dark:border-white/20 bg-white/10 dark:bg-white/5 backdrop-blur-sm text-white placeholder:text-white/40 focus-visible:border-violet-400 focus-visible:ring-violet-500/50 shadow-[0_10px_30px_rgba(139,92,246,0.15)]"
                    />
                    <FormField
                      ...
                      placeholder={t("orders.enterZipCode")}
                      labelClassName="text-white/80"
                      inputClassName="border-violet-400/30 dark:border-white/20 bg-white/10 dark:bg-white/5 backdrop-blur-sm text-white placeholder:text-white/40 focus-visible:border-violet-400 focus-visible:ring-violet-500/50 shadow-[0_10px_30px_rgba(139,92,246,0.15)]"
                    />
                    <FormField
                      ...
                      placeholder={t("orders.enterCountry")}
                      labelClassName="text-white/80"
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    >
                      {t("orders.useSameAddressForBilling")}
                    </Label>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-4 border border-violet-400/20 rounded-lg bg-white/5 space-y-2">
                    ...
                    <div className="flex justify-between text-sm text-white/70">
                      <span>{t("orders.discount")} ({orderFees.discountPercent}%):</span>
              ...
              <DialogFooter className="mt-9 mb-4 flex flex-col sm:flex-row items-center gap-4">
                ...
                >
                  {isCreating ? t("common.loading") : t("orders.createOrder")}
                </Button>
              </DialogFooter>
            </form>
          </FormProvider>
