...
export const createOrderColumns = (
  ...
  return [
  {
    ...
    header: ({ column }) => <SortableHeader column={column} label={t("orders.orderNumber")} />,
    cell: ({ row }) => {
        ...
        <div className="flex flex-col gap-0.5">
          ...
          {showBadge && (
            <div className="flex items-center gap-1.5 flex-wrap">
              ...
              >
                {order._source === "personal" ? t("orders.self") : t("orders.client")}
              </Badge>
            </div>
          )}
          {showPlacedBy && (
  ...
  },
  {
    ...
    header: ({ column }) => <SortableHeader column={column} label={t("orders.paymentStatus")} />,
    cell: ({ row }) => {
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <span>
          {totalItems} {totalItems !== 1 ? t("orders.items_plural") : t("orders.items")}
        </span>
      );
    },
  },
  {
    ...
    header: ({ column }) => <SortableHeader column={column} label={t("orders.date")} />,
    cell: ({ getValue }) => {
