...
const OrderList = React.memo(
  ({ detailHrefBase, dataSource = "orders" }: OrderListProps = {}) => {
    ...
    const columns = useMemo(
      () =>
        createOrderColumns(t, handleEditOrder, effectiveDetailBase, {
          showSourceBadge: dataSource === "adminCombined",
          showPlacedBy: isSupplierOrdersPage,
          showProductOwner: isClientOrdersPage,
        }),
      [t, handleEditOrder, effectiveDetailBase, dataSource, isSupplierOrdersPage, isClientOrdersPage],
    );
      ...
      <div className="flex flex-col poppins">
        ...
        <div className="pb-6 flex flex-col items-start text-left">
          <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 dark:text-white pb-2">
            {isAdminCombined
              ? t("orders.storeOrdersTitle")
              : isClientOrders
                ? t("orders.clientOrdersTitle")
                : isClientOrdersPage
                  ? t("orders.yourOrdersTitle")
                  : isSupplierOrdersPage
                    ? t("orders.supplierOrdersTitle")
                    : t("orders.orderManagement")}
          </h2>
          <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400">
            {isAdminCombined
              ? t("orders.storeOrdersDesc")
              : isClientOrders
                ? t("orders.clientOrdersDesc")
                : isClientOrdersPage
                  ? t("orders.yourOrdersDesc")
                  : isSupplierOrdersPage
                    ? t("orders.supplierOrdersDesc")
        ...
        {isUserOrdersPage && (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 items-stretch pb-6">
            {ordersPageCardsLoading ? (
              ...
              <>
                <StatisticsCard
                  title={t("orders.warehouseCards.totalValue")}
                  value={formatCurrency(
                    ordersPageStats.totalInventoryValue ?? 0,
                  )}
                  description={t("orders.warehouseCards.totalInventoryValue")}
                  icon={DollarSign}
                  variant="violet"
                  badges={[
                    {
                      label: t("orders.warehouseCards.totalOrders"),
                      value: formatCurrency(
                    ...
                    {
                      label: t("orders.warehouseCards.due"),
                      value: formatCurrency(
                    ...
                    {
                      label: t("orders.warehouseCards.cancelled"),
                      value: formatCurrency(
                ...
                />
                <StatisticsCard
                  title={t("orders.warehouseCards.totalRevenue")}
                  value={formatCurrency(
                    ordersPageStats.orderAnalytics
                      ?.totalRevenueExcludingCancelled ??
                      ordersPageStats.revenue?.fromOrders ??
                  ...
                  badges={[
                    {
                      label: t("orders.warehouseCards.paid"),
                      value: formatCurrency(
                    ...
                    {
                      label: t("orders.warehouseCards.refund"),
                      value: formatCurrency(
                        ordersPageStats.orderAnalytics?.refundedAmount ?? 0,
                      ),
                    },
                    {
                      label: t("orders.warehouseCards.pending"),
                      value: formatCurrency(
                    ...
                    ...(ordersPageStats.selfOthersBreakdown
                      ? [
                          {
                            label: t("home.stats.self"),
                            value: formatCurrency(
                              ordersPageStats.selfOthersBreakdown.revenueSelf,
                            ),
                          },
                          {
                            label: t("home.stats.others"),
                            value: formatCurrency(
                ...
                />
                <StatisticsCard
                  title={t("orders.warehouseCards.totalOrders")}
                  ...
                  badges={[
                    ...
                    {
                      label: t("orders.warehouseCards.confirmed"),
                      value:
                        ordersPageStats.orderAnalytics?.statusDistribution
                          ?.confirmed ?? 0,
                    },
                    ...
                    {
                      label: t("orders.warehouseCards.refunded"),
