    ...
    return (
      <PageContentWrapper>
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle>{t("admin.adminDashboard.recentOrders")}</CardTitle>
              <CardDescription>{t("admin.adminDashboard.latest5Orders")}</CardDescription>
            </CardHeader>
            <CardContent>
      ...
      <div className="space-y-6">
          ...
          <Card className="border border-white/10 dark:border-white/10 bg-gradient-to-br from-white/80 to-white/60 dark:from-white/10 dark:to-white/5">
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              <CardTitle className="text-sm font-medium text-muted-foreground">
                {t("admin.adminDashboard.totalOrders")}
              </CardTitle>
              <ShoppingCart className="h-4 w-4 text-blue-600 dark:text-blue-400" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-semibold">{stats.totalOrders}</div>
              <p className="text-xs text-muted-foreground">{t("admin.adminDashboard.allTimeOrders")}</p>
            </CardContent>
          </Card>
          <Card className="border border-white/10 dark:border-white/10 bg-gradient-to-br from-white/80 to-white/60 dark:from-white/10 dark:to-white/5">
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              <CardTitle className="text-sm font-medium text-muted-foreground">
                {t("admin.adminDashboard.totalRevenue")}
              </CardTitle>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">{t("admin.adminDashboard.totalSales")}</p>
            </CardContent>
          </Card>
          <Card className="border border-white/10 dark:border-white/10 bg-gradient-to-br from-white/80 to-white/60 dark:from-white/10 dark:to-white/5">
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              <CardTitle className="text-sm font-medium text-muted-foreground">
                {t("admin.adminDashboard.totalProducts")}
              </CardTitle>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">{t("admin.adminDashboard.activeProducts")}</p>
            </CardContent>
          </Card>
          <Card className="border border-white/10 dark:border-white/10 bg-gradient-to-br from-white/80 to-white/60 dark:from-white/10 dark:to-white/5">
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              <CardTitle className="text-sm font-medium text-muted-foreground">
                {t("admin.adminDashboard.totalUsers")}
              </CardTitle>
              <Users className="h-4 w-4 text-orange-600 dark:text-orange-400" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-semibold">{stats.totalUsers}</div>
              <p className="text-xs text-muted-foreground">{t("admin.adminDashboard.fromOrders")}</p>
            </CardContent>
          </Card>
          <Card className="border border-white/10 dark:border-white/10 bg-gradient-to-br from-white/80 to-white/60 dark:from-white/10 dark:to-white/5">
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              <CardTitle className="text-sm font-medium text-muted-foreground">
                {t("admin.adminDashboard.totalSuppliers")}
              </CardTitle>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">{t("admin.adminDashboard.suppliers")}</p>
            </CardContent>
          </Card>
          <Card className="border border-white/10 dark:border-white/10 bg-gradient-to-br from-white/80 to-white/60 dark:from-white/10 dark:to-white/5">
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              <CardTitle className="text-sm font-medium text-muted-foreground">
                {t("admin.adminDashboard.totalWarehouses")}
              </CardTitle>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">{t("admin.adminDashboard.warehouses")}</p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <Card className="border border-white/10 dark:border-white/10 bg-gradient-to-br from-white/80 to-white/60 dark:from-white/10 dark:to-white/5">
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              <CardTitle className="text-sm font-medium text-muted-foreground">
                {t("admin.adminDashboard.avgOrderValue")}
              </CardTitle>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">{t("admin.adminDashboard.perOrderAverage")}</p>
            </CardContent>
          </Card>
          <Card className="border border-white/10 dark:border-white/10 bg-gradient-to-br from-white/80 to-white/60 dark:from-white/10 dark:to-white/5">
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              <CardTitle className="text-sm font-medium text-muted-foreground">
                {t("admin.adminDashboard.ordersByStatus")}
              </CardTitle>
                ...
                {Object.entries(stats.ordersByStatus).map(([status, count]) => (
                  <li key={status} className="flex justify-between">
                    <span className="capitalize text-muted-foreground">
                      {t(`orders.${status}` as any)}
                    </span>
                    <span className="font-medium">{count}</span>
                  </li>
                ))}
                {Object.keys(stats.ordersByStatus).length === 0 && (
                  <li className="text-muted-foreground">{t("admin.adminDashboard.noOrdersYet")}</li>
                )}
              </ul>
            </CardContent>
          </Card>
        ...
        <Card>
          <CardHeader className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div className="relative w-full sm:w-64">
              ...
              <Input
                placeholder={t("admin.adminDashboard.searchByOrderOrCustomer")}
                value={searchTerm}
          ...
          <CardContent>
            <Table>
              <TableHeader>
                <TableRow>
                  <TableHead>{t("admin.adminDashboard.orderId")}</TableHead>
                  <TableHead>{t("admin.adminDashboard.customer")}</TableHead>
                  <TableHead>{t("admin.adminDashboard.amount")}</TableHead>
                  <TableHead>{t("admin.adminDashboard.items")}</TableHead>
                  <TableHead>{t("admin.adminDashboard.date")}</TableHead>
                  <TableHead className="text-right">{t("admin.adminDashboard.actions")}</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {recentOrders.length === 0 ? (
                  <TableRow>
                    ...
                    >
                      {t("admin.adminDashboard.noOrdersFound")}
                    </TableCell>
                  </TableRow>
                ) : (
                    ...
                    <TableRow key={order.id}>
                      ...
                      <TableCell className="text-right">
                        ...
                        >
                          ...
                          {t("admin.adminDashboard.actions")}
                        </Link>
                      </TableCell>
                    </TableRow>
                  ))
