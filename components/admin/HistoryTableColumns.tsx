  ...
  return [
    {
      ...
      header: ({ column }) => (
        <SortableHeader column={column} label={t("support.importType") || "Import Type"} />
      ),
      cell: ({ getValue }) => {
    ...
    },
    {
      ...
      header: ({ column }) => (
        <SortableHeader column={column} label={t("support.fileName") || "File Name"} />
      ),
      cell: ({ getValue }) => (
        <span
    ...
    },
    {
      ...
      header: ({ column }) => (
        <SortableHeader column={column} label={t("support.totalRows") || "Total Rows"} />
      ),
      cell: ({ getValue }) => (
    ...
    {
      id: "successRows",
      header: t("support.success") || "Success",
      cell: ({ row }) => (
    ...
    {
      id: "failedRows",
      header: t("support.failed") || "Failed",
      cell: ({ row }) => (
