...
export default function AddSupplierDialog({
  ...
  const columns = useMemo<ColumnDef<Supplier>[]>(
    () => createSupplierColumns(t, handleEditSupplier, () => setOpen(false)),
    [t, handleEditSupplier, setOpen]
  );
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogTrigger asChild>
        {children || (
          <Button className="h-10 font-semibold">+{t("suppliers.addSupplier")}</Button>
        )}
      </DialogTrigger>
      <DialogContent className="p-4 sm:p-7 sm:px-8 poppins max-h-[90vh] overflow-y-auto border-emerald-400/30 dark:border-emerald-400/30 shadow-[0_30px_80px_rgba(16,185,129,0.35)] dark:shadow-[0_30px_80px_rgba(16,185,129,0.25)]">
        <DialogHeader>
          ...
          <DialogDescription className="text-white/70">
            {editingSupplier
              ? t("suppliers.updateSupplierDescription")
              : t("suppliers.enterSupplierName")}
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="mt-4">
            ...
            <div className="pb-4">
              ...
              <Textarea
                ...
                placeholder={t("suppliers.enterSupplierDescription")}
                rows={3}
                maxLength={500}
                className="mt-2 w-full bg-white/10 dark:bg-white/5 backdrop-blur-sm border border-emerald-400/30 dark:border-white/20 text-white placeholder:text-white/40 focus-visible:border-emerald-400 focus-visible:ring-emerald-500/50 shadow-[0_10px_30px_rgba(16,185,129,0.15)]"
              />
            ...
            <div className="pb-4">
              ...
              <Textarea
                ...
                placeholder={t("suppliers.enterSupplierNotes")}
                rows={3}
                maxLength={1000}
                className="mt-2 w-full bg-white/10 dark:bg-white/5 backdrop-blur-sm border border-emerald-400/30 dark:border-white/20 text-white placeholder:text-white/40 focus-visible:border-emerald-400 focus-visible:ring-emerald-500/50 shadow-[0_10px_30px_rgba(16,185,129,0.15)]"
              />
          ...
          <>
            <div className="pb-4">
              <Input
                ...
                placeholder={t("suppliers.newSupplier")}
            ...
            <DialogFooter className="mt-9 mb-4 flex flex-col sm:flex-row items-center gap-4">
              ...
              >
                {isSubmitting ? t("common.loading") : t("suppliers.addSupplier")}
              </Button>
            </DialogFooter>
          </>
        )}
