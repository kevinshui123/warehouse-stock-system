          ...
          <div className="space-y-6">
            ...
            >
              <p className="text-muted-foreground text-center">
                {t("client.failedToLoadClientDashboard")}
              </p>
              <div className="flex justify-center mt-4">
                <Button asChild variant="outline">
                  <Link href="/">{t("client.goToDashboard")}</Link>
                </Button>
              </div>
            </article>
          </div>
        ...
        <div className="space-y-6">
          <div className="">
            ...
            <p className="text-sm sm:text-base text-muted-foreground">
              {t("client.welcomeMessage", { name: dashboard.clientName })}
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
            <StatisticsCard
              ...
              description={t("client.yourOrderHistory")}
              icon={ShoppingCart}
              variant="sky"
              badges={[
                {
            ...
            />
            <StatisticsCard
              title={t("client.awaitingPayment")}
              value={dashboard.ordersAwaitingPayment ?? 0}
              description={t("client.ordersAwaitingPayment")}
              icon={Clock}
              variant="amber"
              badges={[
                {
                ...
                { label: t("client.ofTotal"), value: dashboard.totalOrders },
              ]}
            />
            <StatisticsCard
              ...
              description={t("client.totalOrderValue")}
              icon={DollarSign}
              variant="emerald"
              badges={[
                {
            ...
            />
            <StatisticsCard
              title={t("client.outstanding")}
              value={`$${dashboard.outstandingAmount.toLocaleString(undefined, {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2,
              })}`}
              description={t("client.unpaidInvoiceBalance")}
              icon={AlertCircle}
              variant="rose"
              badges={[
                ...(dashboard.outstandingAmount === 0
                  ? [{ label: t("common.status"), value: t("client.allPaid") }]
                  : []),
                {
                  label: t("client.invoicesPaid"),
            ...
            >
              <div className="mb-4">
                ...
                <p className="text-sm text-gray-600 dark:text-white/70 mt-1">
                  {t("client.yourSpendingLast6Months")}
                </p>
              </div>
          ...
          >
            <div className="mb-6">
              <h3 className="flex items-center gap-2 text-lg font-semibold text-gray-900 dark:text-white">
                ...
                {t("client.catalogWhatsAvailable")}
              </h3>
              <p className="text-sm text-gray-600 dark:text-white/70 mt-1">
                {t("client.browseSuppliersCategoriesProducts")}
              </p>
            </div>
            <div className="space-y-6">
              {catalogLoading && (
                      ...
                      <Table>
                        <TableHeader>
                          <TableRow>
                            <TableHead>{t("common.name")}</TableHead>
                            <TableHead>{t("common.status")}</TableHead>
                            <TableHead>{t("client.productOwner")}</TableHead>
                            <TableHead className="text-right">
                              {t("client.products")}
                            </TableHead>
                          </TableRow>
                  ...
                  <div>
                    ...
                    <div className="overflow-x-auto rounded-md border">
                      <Table>
                        <TableHeader>
                          <TableRow>
                            <TableHead>{t("client.productName")}</TableHead>
                            <TableHead>{t("client.sku")}</TableHead>
                            <TableHead>{t("client.category")}</TableHead>
                            <TableHead>{t("client.supplier")}</TableHead>
                            <TableHead>{t("client.productOwner")}</TableHead>
                            <TableHead className="text-right">{t("client.price")}</TableHead>
                            <TableHead>{t("common.status")}</TableHead>
                          </TableRow>
                        </TableHeader>
                        <TableBody>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div>
                {dashboard.recentOrders.length === 0 ? (
                  ...
                  <div className="overflow-x-auto">
                    <Table>
                      <TableHeader>
                        <TableRow>
                          <TableHead>{t("client.orderNumber")}</TableHead>
                          ...
                          <TableRow key={order.id}>
                            <TableCell>
                              ...
                              <p className="text-xs text-muted-foreground">
                                {order.itemCount} {t("client.items")}
                              </p>
                            </TableCell>
                            <TableCell className="text-right">
                ...
                <div className="mt-4">
                  <Button
                    ...
                    className="w-full"
                  >
                    <Link href="/orders">{t("client.viewAllOrders")}</Link>
                  </Button>
                </div>
              </div>
            </article>
            ...
            >
              <div className="mb-4">
                ...
                <p className="text-sm text-gray-600 dark:text-white/70 mt-1">
                  {t("client.yourLatestInvoices")}
                </p>
              </div>
              <div>
                {dashboard.recentInvoices.length === 0 ? (
                  <p className="text-muted-foreground text-center py-4">
                    {t("client.noInvoicesYet")}
                  </p>
                ) : (
                  <div className="overflow-x-auto">
                    <Table>
                      <TableHeader>
                        <TableRow>
                          <TableHead>{t("client.invoiceNumber")}</TableHead>
                          <TableHead className="text-right">{t("invoices.amountDue")}</TableHead>
                          <TableHead>{t("common.status")}</TableHead>
                        </TableRow>
                      </TableHeader>
                      <TableBody>
                ...
                <div className="mt-4">
                  <Button
                    ...
                    className="w-full"
                  >
                    <Link href="/invoices">{t("client.viewAllInvoices")}</Link>
                  </Button>
                </div>
              </div>
            </article>
