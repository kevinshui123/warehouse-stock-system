...
export default function CategoryFilters({
    ...
    try {
      if (filteredCategories.length === 0) {
        toast({
          ...
          description: t("categories.noDataToExport"),
          variant: "destructive",
        });
        return;
      }
      ...
      const csvData = filteredCategories.map((category) => ({
        ...
        [t("common.status")]: category.status ? t("common.active") : t("common.inactive"),
        [t("common.description")]: category.description || "-",
        [t("common.notes")]: category.notes || "-",
        [t("common.createdAt")]: category.createdAt
          ? new Date(category.createdAt).toLocaleDateString()
          : "-",
        [t("common.updatedAt")]: category.updatedAt
      ...
      toast({
        title: t("categories.exportSuccess"),
        description: t("categories.categoriesExportedCsv", { count: filteredCategories.length }),
      });
    } catch (error) {
      toast({
        title: t("common.error"),
        description: t("categories.exportFailed"),
        variant: "destructive",
      });
    }
  }, [filteredCategories, toast, t]);
  ...
  const exportToExcel = useCallback(async () => {
    try {
      ...
      worksheet.columns = [
        { header: t("categories.categoryName"), key: t("categories.categoryName"), width: 25 },
      ...
      toast({
        title: t("categories.exportSuccess"),
        description: t("categories.categoriesExportedExcel", { count: filteredCategories.length }),
      });
    } catch (error) {
      toast({
        title: t("common.error"),
