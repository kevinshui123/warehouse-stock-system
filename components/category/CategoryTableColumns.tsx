...
export const createCategoryColumns = (
  ...
  return [
  {
    ...
    header: ({ column }) => <SortableHeader column={column} label={t("categories.categoryName")} />,
    size: 15,
  },
  {
    accessorKey: "status",
  ...
  },
  {
    ...
    header: ({ column }) => <SortableHeader column={column} label={t("common.description")} />,
    cell: ({ row }) => {
  ...
  {
    accessorKey: "notes",
    header: ({ column }) => <SortableHeader column={column} label={t("common.notes")} />,
    cell: ({ row }) => {
  ...
  },
  {
    ...
    cell: ({ getValue }) => {
      ...
      if (!date || isNaN(date.getTime())) {
        return (
          <span className="text-gray-900 dark:text-white">{t("products.unknownDate")}</span>
        );
      }
  ...
  },
  {
    ...
    header: ({ column }) => (
      <SortableHeader column={column} label={t("common.updatedAt")} />
    ),
    cell: ({ getValue }) => {
